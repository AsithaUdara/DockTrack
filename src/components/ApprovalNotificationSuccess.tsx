...
export default function ApprovalNotificationSuccess() {
    const router = useRouter();

    return (
        <div className="min-h-screen bg-transparent flex items-center justify-center p-4">
            <div className="bg-blue-900  w-2/3 p-6 text-white rounded-lg  text-center">
                {/* Success Icon */}
                ...
                <div className="flex justify-center">
                    <button
  onClick={() => {
    // Close the popup by navigating away
    document.body.dispatchEvent(new CustomEvent('close-success-popup'));
    router.push('/reports');
  }}
  className="bg-green-500 text-white px-6 py-2 rounded-full font-medium hover:bg-green-600"
>
  VIEW REPORT
</button>
